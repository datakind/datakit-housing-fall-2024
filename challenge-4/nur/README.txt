...
The project’s dataset focuses on Florida's housing landscape. Before conducting the analysis, columns representing the margin of error were removed from the dataset. A clustering method was employed to identify high-risk areas within the community. For visualization, Plotly, Folium, and Matplotlib were used to create both interactive and non-interactive plots. This data provides a foundation for understanding community vulnerability to disasters.
